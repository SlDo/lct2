...
import { Styled } from '@pages/Home/components/Menu/components/CameraList/components/CameraListItem/styled';
import { type CameraListItemProps } from '@pages/Home/components/Menu/components/CameraList/components/CameraListItem/types';
